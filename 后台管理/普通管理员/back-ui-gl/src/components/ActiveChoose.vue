<template>
  <div>
    ...
    <div class="query-btn">
      ...
      <div>
        <el-button type="success" size="medium" icon="el-icon-plus" @click="openadd = true">添加</el-button>
      </div>
      <div>
        <el-button type="primary" size="medium" icon="el-icon-refresh-right" round @click="queryNew">刷新</el-button>
      </div>
    </div>
    <div>
      <el-table :data="activelist" stripe v-loading="activeloading" height="340">
        ...
        <el-table-column label="操作">
          <template slot-scope="socpe">
            <el-button size="medium" @click="selectFile(socpe.row)">选择活动</el-button>
          </template>
        </el-table-column>
      </el-table>
