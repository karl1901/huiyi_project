  ...
  <div class="main" v-loading="loading" element-loading-text="拼命加载中" element-loading-spinner="el-icon-loading" element-loading-background="rgba(0, 0, 0, 0.8)">
    ...
    <el-tabs type="card">
      ...
      <el-tab-pane label="图片展示文字">
        ...
        <div>
          <el-table :data="fjtpxxlist" stripe v-loading="fjtpxxloading" height="400">
        ...
        <el-form>
          ...
          <el-form-item label="选择文件："> -->
            ...
            <div class="choose-btn">
              <el-button size="medium" type="info" plain @click="fileVisible03 = true">选择图片</el-button>
            </div>
          </el-form-item>
          <el-form-item label="内容描述：">
            <el-button size="medium" type="primary" plain @click="Visibleadd = true">添加内容</el-button>
    ...
    <div>
      <el-dialog title="添加内容编辑框" :close-on-click-modal="false" :visible.sync="Visibleadd">
        ...
        <div>
          <el-button size="medium" type="primary" @click="Visibleadd = false">确定</el-button>
