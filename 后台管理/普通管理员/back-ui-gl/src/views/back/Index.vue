    ...
    <el-tabs type="border-card">
          ...
          <el-tabs :tab-position="(tabPosition = 'left')" style="height: 640px;">
            ...
            <el-tab-pane label="活动信息">
              ...
              <div class="query-btn">
                ...
                <div>
                  <el-button type="primary" size="medium" icon="el-icon-search" @click="queryActive">查询</el-button>
                </div>
                <div>
                  <el-button type="success" size="medium" icon="el-icon-plus" @click="openadd = true">活动</el-button>
                </div>
                <div>
                  <el-button type="success" size="medium" icon="el-icon-plus" @click="openaddactivetp = true">活动图片</el-button>
                </div>
                <div>
                  <el-button type="warning" size="medium" icon="el-icon-refresh-right" round @click="queryNew">刷新</el-button>
                </div>
              </div>
              <div>
                <el-table :data="activelist" stripe v-loading="activeloading" height="365">
            ...
            <el-tab-pane label="活动图片">
              ...
              <div class="query-btn">
                <div>
                  <el-button type="success" size="medium" icon="el-icon-plus" @click="openaddhdtp = true">添加</el-button>
                </div>
                <div>
                  <el-button type="primary" size="medium" icon="el-icon-refresh-right" round @click="queryNewhdtp">刷新</el-button>
                </div>
              </div>
              <div>
                <el-table :data="hdtplist" stripe v-loading="hdtploading" height="425">
                  ...
                  <el-table-column label="操作">
                    <template slot-scope="socpe">
                      <el-button type="success" size="medium" plain icon="el-icon-search" v-if="isImage(socpe.row)" @click="showhdtp(socpe.row)">预览</el-button>
                      <el-button type="primary" size="medium" plain icon="el-icon-download" @click="downloadhdtp(socpe.row)"></el-button>
                      <el-button type="danger" size="medium" plain icon="el-icon-delete" @click="delhdtp(socpe.row)"></el-button>
                    </template>
                  </el-table-column>
                </el-table>
        ...
        <div>
          <el-tabs :tab-position="(tabPosition = 'left')" style="height: 570px;">
            ...
            <el-tab-pane label="标题">
              ...
              <div class="query-btn">
                <div>
                  <el-button size="medium" type="success" icon="el-icon-plus" @click="tjbt">添加</el-button>
                </div>
                <div>
                  <el-button size="medium" type="primary" icon="el-icon-refresh-right" round @click="queryNewfjbt">刷新</el-button>
                </div>
              </div>
              <div>
                <el-table :data="fjbtlist" stripe v-loading="fjbtloading" height="340">
                  ...
                  <el-table-column label="操作">
                    <template slot-scope="socpe">
                      ...
                      <el-button type="primary" size="medium" plain icon="el-icon-edit" @click="showupdatefjbt(socpe.row)">编辑</el-button>
                      <el-button type="danger" size="medium" plain icon="el-icon-delete" @click="delfjbt(socpe.row)">删除</el-button>
                    </template>
                  </el-table-column>
                </el-table>
            ...
            <el-tab-pane label="展示图片">
              ...
              <div>
                <el-table :data="fjtplist" stripe v-loading="fjtploading" height="425">
                  <!-- <el-table-column label="文件编号" prop="fid"></el-table-column>
                  <el-table-column label="文件名称" prop="filename"></el-table-column> -->
                  <el-table-column label="文件描述" prop="fileinfo"></el-table-column>
            ...
            <el-tab-pane label="图片信息">
              ...
              <div>
                <el-table :data="fjtpxxlist" stripe v-loading="fjtpxxloading" height="425">
                  <!-- <el-table-column label="信息分组" prop="messageGroup"></el-table-column>
                  <el-table-column label="信息关键词" prop="messageKey"></el-table-column> -->
                  <el-table-column label="风景图片">
                    <template slot-scope="socpe">
      ...
      <el-tab-pane label="一些话">
        ...
        <div>
          ...
          <div class="query-btn">
            <div>
              <el-button type="success" size="medium" icon="el-icon-plus" @click="tjyxh">添加</el-button>
            </div>
            <div>
          ...
          <div>
            <el-table :data="yxhlist" stripe v-loading="yxhloading" height="427">
              <!-- <el-table-column label="信息分组" prop="messageGroup"></el-table-column> -->
      ...
      <el-dialog :visible.sync="openupdate" :close-on-click-modal="false" title="编辑活动信息">
        <div>
          <el-form>
            ...
            <el-form-item>
              <el-button size="medium" type="success" @click="update">保存</el-button>
              <el-button size="medium" @click="openupdate = false">关闭</el-button>
            </el-form-item>
          </el-form>
        </div>
      </el-dialog>
        ...
        <el-form>
          ...
          <el-form-item>
            <div class="ckhd-close">
              <el-button size="medium" @click="openck = false">关闭</el-button>
            </div>
          </el-form-item>
        </el-form>
      </el-dialog>
    ...
    <div>
      <el-dialog :visible.sync="openaddhdtp" :close-on-click-modal="false" title="添加活动图片">
        <el-form>
          ...
          <el-form-item>
            <el-button size="medium" @click="openhdFile">选择文件...</el-button>
            <span v-if="hdfile">&nbsp;{{ hdfile.name }}</span>
            <br />
            <span style="color:	#FFA500;">提示：文件大小不能超过2M！</span>
          </el-form-item>
          <el-form-item>
            <el-button size="medium" type="success" @click="addhdtp">添加</el-button>
            <el-button size="medium" @click="resetaddhdtp">重置</el-button>
          </el-form-item>
        </el-form>
      </el-dialog>
    </div>
    ...
    <div>
      <el-dialog :visible.sync="openaddfjbt" :close-on-click-modal="false" title="添加标题">
        <el-form>
          ...
          <el-form-item>
            <el-button size="medium" type="success" @click="addfjbt">添加</el-button>
            <el-button size="medium" @click="resetaddfjbt">重置</el-button>
          </el-form-item>
        </el-form>
      </el-dialog>
    </div>
      ...
      <el-dialog :visible.sync="openupdatefjbt" :close-on-click-modal="false" title="编辑标题">
        <div>
          <el-form>
            ...
            <el-form-item>
              <el-button size="medium" type="success" @click="updatefjbt">保存</el-button>
              <el-button size="medium" @click="openupdatefjbt = false">关闭</el-button>
            </el-form-item>
          </el-form>
        </div>
      </el-dialog>
        ...
        <el-form>
          ...
          <el-form-item label="所属风景图片：">
            ...
            <div class="choose-btn01">
              <el-button size="medium" @click="fileVisible03 = true">选择图片</el-button>
            </div>
          </el-form-item>
          <el-form-item label="内容描述：">
          ...
          <el-form-item>
            <el-button size="medium" type="success" @click="addfjtpxx">添加</el-button>
        ...
        <div>
          <el-form>
            ...
            <el-form-item label="选择文件："> -->
              ...
              <div class="choose-btn01">
                <el-button size="medium" @click="fileVisible04 = true">浏览文件</el-button>
              </div>
            </el-form-item>
            <el-form-item label="信息内容：">
      ...
      <el-dialog :visible.sync="openaddactivetp" :close-on-click-modal="false" title="添加活动图片">
        <el-form>
          ...
          <el-form-item label="所属活动：">
            ...
            <el-button size="medium" class="choose-btn" @click="fileVisible01 = true">选择活动</el-button>
          </el-form-item>
          <el-form-item label="活动图片：">
            ...
            <div>
              <el-button size="medium" class="choose-btn" @click="fileVisible = true">选择图片</el-button>
            </div>
          </el-form-item>
          ...
          <el-form-item>
            <el-button size="medium" type="success" @click="addtp">添加</el-button>
            <el-button size="medium" @click="resetaddtp">重置</el-button>
          </el-form-item>
        </el-form>
      </el-dialog>
    </div>
