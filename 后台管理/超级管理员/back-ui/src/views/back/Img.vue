  ...
  <div class="main" v-loading="loading" element-loading-text="拼命加载中" element-loading-spinner="el-icon-loading" element-loading-background="rgba(0, 0, 0, 0.8)">
    ...
    <el-tabs type="card">
      <el-tab-pane label="图片管理">
        <span slot="label"><i class="el-icon-picture"></i> 图片管理</span>
        <div class="classhd">展示图片管理</div>
        ...
        <div>
          <el-table :data="fjtplist" stripe v-loading="fjtploading" height="410">
      ...
      <el-tab-pane label="图片信息管理">
        <span slot="label"><i class="el-icon-document"> 图片信息管理</i></span>
        <div class="classhd">图片信息管理</div>
        ...
        <div>
          <el-table :data="fjtpxxlist" stripe v-loading="fjtpxxloading" height="410">
