    ...
    <el-tabs type="border-card">
      ...
      <el-tab-pane label="班级档案">
        ...
        <div>
          ...
          <div>
            <el-table :data="activelist" stripe v-loading="activeloading" height="360">
        ...
        <div>
          <el-tabs :tab-position="(tabPosition = 'left')" style="height: 570px;">
            ...
            <el-tab-pane label="展示图片">
              ...
              <div>
                <el-table :data="fjtplist" stripe v-loading="fjtploading" height="390">
                  ...
                  <el-table-column label="操作">
                    <template slot-scope="socpe">
                      ...
                      <el-button type="danger" plain icon="el-icon-delete" @click="delfjtp(socpe.row)">删除</el-button>
                    </template>
                  </el-table-column>
                </el-table>
            ...
            <el-tab-pane label="图片信息">
              ...
              <div>
                <el-table :data="fjtpxxlist" stripe v-loading="fjtpxxloading" height="360">
                  <el-table-column label="信息分组" prop="messageGroup"></el-table-column>
                  <el-table-column label="信息关键词" prop="messageKey"></el-table-column>
      ...
      <el-tab-pane label="一些话">
        ...
        <div>
          ...
          <div>
            <el-table :data="yxhlist" stripe v-loading="yxhloading" height="370">
              <el-table-column label="信息分组" prop="messageGroup"></el-table-column>
              <el-table-column label="信息关键词" prop="messageKey"></el-table-column>
              <el-table-column label="最后修改时间" sortable prop="lastupdate">
                <template slot-scope="scope">
